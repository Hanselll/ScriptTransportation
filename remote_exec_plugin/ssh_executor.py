...
def run_remote_command(server_ip, username, password, command, timeout=600, ssh_port=22):
    ...
    logger.info("Running remote command on %s:%s: %s", server_ip, ssh_port, command)
